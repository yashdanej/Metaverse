...
const Profile = ({myStory, followingUser, theme, setGetUserId, getProfile, postLiked, handleProfileUpdate, loggedUserPost, handleProfileVisit, getUserId, handleFollow, getLoggedUser, allSuggetion}) => {
  return (
    <div className='profile'>
        <div className="container">
            <div className="d-flex itemsJustify">
                <div className={`firstContainer p-4 ${theme?'firstC':''} paddingSmall`}>
                    <LeftComponent myStory={myStory} theme={theme} handleProfileUpdate={handleProfileUpdate} loggedUserPost={loggedUserPost} handleProfileVisit={handleProfileVisit} getLoggedUser={getLoggedUser} handleFollow={handleFollow} />
                </div>
